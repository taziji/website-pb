...
module.exports = function(pb) {
  ...
  var Page = function() {};
  util.inherits(Page, pb.BaseController);
   ...
   * @param {Function} cb
   */
  Page.prototype.init = function(context, cb) {
      var self = this;
      ...
      Page.super_.prototype.init.apply(this, [context, init]);
  };
   ...
   * @param {Function} cb
   */
  Page.prototype.onPage = function(cb) {
      var self    = this;
      ...
      this.service.getSingle(opts, function(err, content) {
          ...
          self.ts.registerLocal('layout', new pb.TemplateValue(content.layout, false));
   ...
   */
  Page.prototype.getWhereClause = function(custUrl) {
  ...
  Page.prototype.getNavigation = function(cb) {
      var options = {
          currUrl: 'home'
      };
  ...
  Page.prototype.gatherData = function(content, cb) {
      var self  = this;
      var tasks = {
  ...
  Page.prototype.getGridImages = function( content, cb) {
