...
module.exports = function(pb) {
   ...
   * @param {Function} cb
   */
  Blog.prototype.init = function(context, cb) {
      var self = this;
      ...
      Blog.super_.prototype.init.apply(this, [context, init]);
  };
   ...
   * @param {Function} cb
   */
  Blog.prototype.feed = function(cb) {
      var self    = this;
   ...
   */
  Blog.prototype.getWhereClause = function(custUrl) {
  ...
  // Blog.prototype.getGridImages = function( content, cb) {
  ...
  Blog.prototype.gatherData = function(content, cb) {
      var self  = this;
      var tasks = {
